...
#For each way that the function can fail this test, create a branch where you edit the code in some way to make the code fail to pass the unit testing.

#The code below will ensure that the function fails because it does not calculate appropriate d statistics.
...
testing <- function(Yes.Benfords, No.Benfords){                 #Sets Yes.Benfords and No.Benfords as the two arguments in the function "testing."
  ...
  d3 <- d3*0                                                    #This line of code calculates the wrong Cho-Gains' d statistic for Yes.Benfords.
  ...
  d3.2 <- d3.2*0                                                #This line of code calculates the wrong Cho-Gains' d statistic for No.Benfords
...
testing(Yes.Benfords, No.Benfords)                              #Output reads "FALSE" and "The function calculates wrong Cho-Gain statistics."
