...
#For each way the function can fail this test, create a branch where you edit the code in some way to make the code fail to pass the unit testing.

#In the code below, the function will fail to calculate appropriate Leemis' m statistics.
...
testing <- function(Yes.Benfords, No.Benfords){                 #Sets Yes.Benfords and No.Benfords as the two arguments in the function "testing."
  ...
  m2 <- m2*0                                                    #This line of code calculates the wrong Leemis' m statistic for Yes.Benfords.
  ...
  m2.2 <- m2.2*0                                                #This line of code calculates the wrong Leemis' m statistic for No.Benfords.
...
testing(Yes.Benfords, No.Benfords)                              #Output says "FALSE" and "The function calculates wrong Leemis statistics."
